getwd();
workingDir = "D:/wgcna/WGCNA_SCZ_Mic_Ast/microglia";
setwd(workingDir);
...
exp = read.csv("./pb_microglia_control_filtered.csv")
...
adjacency = adjacency(datTrain, power=9); ########################################### POWER
...
# save weight matrix
write.csv(TOM, file="./df_tom_similarity_microglia.csv")
# ========================================================================
...
write.csv(df_modules, file = "./modules_whole_microglia.csv")
# ========================================================================
...
write.csv(temp, file="./df_zsummary_microglia.csv")
