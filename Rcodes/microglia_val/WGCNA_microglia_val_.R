...
adjacency = adjacency(datTrain, power=5); ########################################### POWER
...
# save weight matrix
write.csv(TOM, file="./df_tom_similarity_microglia_val.csv")
...
write.csv(df_modules, file = "./modules_whole_microglia_val.csv")
...
write.csv(temp, file="./df_zsummary_microglia_val.csv")
